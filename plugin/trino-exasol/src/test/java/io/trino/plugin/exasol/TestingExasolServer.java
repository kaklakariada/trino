        ...
        implements Closeable
{
    ...
    {
        container = new FixedHostPortExasolContainer<>("exadockerci4/docker-db:2025.1.8_dev_java_slc_only") //Test container tailored to reduce used disk space and solve CI disk space pressure issue.
                .withExposedPorts(8563)
                .withRequiredServices(ExasolService.JDBC)
                .withFixedExposedWorkerNodePorts()
