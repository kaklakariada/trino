        ...
        implements ConnectorPageSourceProvider
{
    ...
    @Inject
    public ExasolParallelConnectionPageSourceProvider(JdbcClient jdbcClient, @ForJdbcClient ExecutorService executor, RetryPolicy<Object> policy, ParallelConnectionFactory parallelConnectionFactory)
    {
            ...
            DynamicFilter dynamicFilter)
    {
        ...
        if (mergeRowId.isEmpty()) {
            return ExasolParallelConnectionPageSource.create(
                    jdbcClient,
                    executor,
    ...
    {
        return retry(policy, () -> ExasolParallelConnectionPageSource.create(jdbcClient, executor, parallelConnectionFactory, session, jdbcSplit, table, columnHandles));
    }
